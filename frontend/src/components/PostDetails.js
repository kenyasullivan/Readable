  ...
  render(){
    ...
    return (
      ...
      <Link to="/">Back To Home</Link>
        ...
        <p>{post.body}</p>
        <button type="submit" className="btn btn-primary" onClick={this.onEditSubmit.bind(this)}>
        Edit
      </button>
        <button
...
export default connect(mapStateToProps, {fetchPost, deletePost, editPost})(PostDetails);